...
OPT = [
    ...
    dict(L="G) SunWash\nMICRO 10x650W\n4x 2,25 kW", emp="SunWash Energia Solar e Ar-Condicionado", nome="Yuri", fone="(16) 99353-4346",
         ...
         qty=10, wp=650, mod="ZNShine ZXNR-MD132-650 N-type (Tier 1 BNEF)", inv="4x DEYE SUN-S225G4-EU-Q0 2,25 kW = 9,0 kW AC",
         ac=9.0, mppt="4 por micro = 16 canais (10 usados, 6 livres)", volt="220 V (a confirmar)",
         telha="nao informada",
         gmod="nao declarada pelo vendedor - exigir por escrito (N-type costuma dar 12/25 a 30 anos)",
         ginv="nao declarada pelo vendedor - a Deye pratica 10 anos, exigir por escrito",
         gserv="nao informada", excl="nao informadas",
